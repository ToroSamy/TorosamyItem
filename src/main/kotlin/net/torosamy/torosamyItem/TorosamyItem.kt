...
import net.torosamy.torosamyItem.utils.SchedulerUtil
import org.bukkit.Bukkit
import org.bukkit.plugin.java.JavaPlugin

class TorosamyItem : JavaPlugin() {
    companion object {
        lateinit var plugin: TorosamyItem
...
//        TorosamyItemAPI.updateBindEnable()
        ...
        Bukkit.getConsoleSender().sendMessage(MessageUtil.format("&b[服务器娘]&a插件 &eTorosamyItem &a成功开启喵~"))
    ...
    override fun onDisable() {
        ...
        Bukkit.getConsoleSender().sendMessage(MessageUtil.format("&b[服务器娘]&c插件 &eTorosamyItem &c成功关闭喵~"))
